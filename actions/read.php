<a href="create.php"><button>add member</button></a>
...
<tbody>
 ...
 <td><a href="update.php?id=<?php echo htmlentities($row['id']);?>"><button class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-pencil">update</span></button></a></td>
